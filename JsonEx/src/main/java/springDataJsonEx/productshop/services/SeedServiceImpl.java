...
import springDataJsonEx.productshop.entities.categories.CategoryImportDTO;
import springDataJsonEx.productshop.entities.products.Product;
import springDataJsonEx.productshop.entities.products.ProductImportDTO;
import springDataJsonEx.productshop.entities.users.User;
import springDataJsonEx.productshop.entities.users.UserImportDTO;
import springDataJsonEx.repositories.CategoryRepository;
...
public class SeedServiceImpl implements SeedService {
    ...
    private final String USERS_JSON_PATH = "src/main/resources/productshop/users.json";
    private final String CATEGORIES_JSON_PATH = "src/main/resources/productshop/categories.json";
    private final String PRODUCTS_JSON_PATH = "src/main/resources/productshop/products.json";
